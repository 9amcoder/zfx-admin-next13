...
interface WalletDetailsComponentProps {}

export const WALLET_DETAILS_DATA = [
  {
    id: 1,
    cardLabel: "Trading",
    dropdownLabel: "842986 - Standard STP Account - 0 USD",
    isAmount: false,
  },
  {
    id: 2,
    cardLabel: "Amount",
    dropdownLabel: "Please enter amount to transfer",
    isAmount: true,
  },
];

const WalletDetailsComponent: FunctionComponent<
  WalletDetailsComponentProps
> = () => {
  return (
    <>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-full">
                          ...
                          <DropdownMenuGroup>
                            ...
                            <DropdownMenuItem>
                              <User className="mr-2 h-4 w-4" />
                              <span>Profile A ZFX Trading 0011</span>
                            </DropdownMenuItem>
                          </DropdownMenuGroup>
                        </DropdownMenuContent>
                      </DropdownMenu>
